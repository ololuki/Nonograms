 ...
 *********************************************************************/
#ifndef BLOCKSFROMDOTANDFILLEDTEST_H
#define BLOCKSFROMDOTANDFILLEDTEST_H

#include <QtTest>


class BlocksFromDotAndFilledSolverTest : public QObject
{
	Q_OBJECT
private slots:
...
#endif // BLOCKSFROMDOTANDFILLEDTEST_H
